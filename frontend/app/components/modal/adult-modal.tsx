        ...
        <ModalContainer>
            <div className="flex flex-col items-center gap-4 bg-neutral-900 p-6 rounded-lg text-center">
                ...
                <div className="grid grid-cols-1 gap-4 w-full text-lg">
                    <button className="bg-red-500 text-white px-4 py-4 rounded w-full cursor-pointer" onClick={onAccept}>Sou maior de 18</button>
                    <button className="bg-black text-white px-4 py-4 rounded w-full cursor-pointer" onClick={onDecline}>Sou menor idade</button>
                </div>
            </div>
        </ModalContainer>
    )
